---
tieu_de: "Giải Toán 10 Tập 1 trang 72-75 - Kết nối tri thức"
slug: "giai-toan-10-tap-1-trang-72-75-kntt"
lop: "10"
loai: "giai-sgk"
mon: "toan"
bo_sach: "ket-noi-tri-thuc"
tom_tat: "Giải bài tập Toán 10 Tập 1 trang 72-75 Kết nối tri thức. Lời giải chi tiết, đủ bước, dành cho học sinh THPT."
meta_title: "Giải Toán 10 Tập 1 trang 72-75 - Kết nối tri thức"
meta_description: "Giải bài tập Toán 10 Tập 1 trang 72-75 Kết nối tri thức. Lời giải chi tiết từng bài, đầy đủ các bước."
---
...
**Lời giải:**
Hai vecto $\overrightarrow{a}$ và $\overrightarrow{b}$ có cùng phương nếu tồn tại số thực $k$ sao cho $\overrightarrow{a} = k\overrightarrow{b}$.
...
**Lời giải:**
Hai vecto $\overrightarrow{a}$ và $\overrightarrow{b}$ vuông góc nếu $\overrightarrow{a} \cdot \overrightarrow{b} = 0$.
...
**Lời giải:**
Vecto $\overrightarrow{a} = (x; y)$ có độ dài $\left| \overrightarrow{a} \right| = \sqrt{x^2 + y^2}$.
...
**Lời giải:**
Công thức tính góc giữa 2 vecto $\overrightarrow{a}$ và $\overrightarrow{b}$: 
$\cos (\overrightarrow{a}, \overrightarrow{b}) = \frac{\overrightarrow{a} \cdot \overrightarrow{b}}{\left| \overrightarrow{a} \right| \cdot \left| \overrightarrow{b} \right|}$.
...
**Lời giải:**
a) Ta có $MB = 3MC \Rightarrow \overrightarrow{MB} = 3 \overrightarrow{MC}$.
...
&= \overrightarrow{MB} + \overrightarrow{MD} + \overrightarrow{BA} + \overrightarrow{BA} \\
...
$$
\begin{aligned}
G &= \left(\frac{2 + (-2) + (-5)}{3}; \frac{1 + 5 + (-2)}{3}\right) \\
...
**Lời giải:**
Vì $BCAD$ là hình bình hành nên $\overrightarrow{CA} = \overrightarrow{DB}$.
...
Từ $\overrightarrow{CA} = \overrightarrow{DB}$:
...
**Lời giải:**
Ta có: $\overrightarrow{CD} = \frac{7}{2} \overrightarrow{AB}$.
...
$$
\begin{aligned}
\left(\frac{7}{2}; -1\right) &= m(2; 2) + n(-2; -4) \\
&= (2m - 2n; 2m - 4n).
\end{aligned}
$$
...
\begin{aligned}
n &= \frac{7}{4} - m \\
m - 2(\frac{7}{4} - m) &= -\frac{1}{2} \\
m - \frac{7}{2} + 2m &= -\frac{1}{2} \\
3m &= 3 \\
m &= 1 \\
n &= \frac{3}{4}.
\end{aligned}
