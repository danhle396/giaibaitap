---
tieu_de: "Giải Toán 10 Tập 2 trang 9-12 - Chân trời sáng tạo"
slug: "giai-toan-10-tap-2-trang-9-12-ctst"
lop: "10"
loai: "giai-sgk"
mon: "toan"
bo_sach: "chan-troi-sang-tao"
tom_tat: "Giải bài tập Toán 10 Tập 2 trang 9-12 Chân trời sáng tạo. Lời giải chi tiết, đủ bước, dành cho học sinh THPT."
meta_title: "Giải Toán 10 Tập 2 trang 9-12 - Chân trời sáng tạo"
meta_description: "Giải bài tập Toán 10 Tập 2 trang 9-12 Chân trời sáng tạo. Lời giải chi tiết từng bài, đầy đủ các bước."
---
...
**Lời giải:**
- **Xác định nghiệm**: 
  - Giải phương trình $x^2 + 1,5x - 1 = 0$:

$$
\Delta = b^2 - 4ac = (1,5)^2 - 4(1)(-1) = 2.25 + 4 = 6.25.
$$
...
$$
x_1 = 0.5 \quad \text{và} \quad x_2 = -2.
$$
...
**Lời giải:**
- **Xác định nghiệm**: 
  - Giải phương trình $-0.5x^2 + 3x - 6 = 0$:

$$
\Delta = b^2 - 4ac = 3^2 - 4(-0.5)(-6) = 9 - 12 = -3 < 0.
$$
...
**Lời giải:**
- **Xác định nghiệm**: 
  - Giải phương trình $-x^2 - 0.5x + 3 = 0$:
...
$$
x_1 = -2 \quad \text{và} \quad x_2 = 1.5.
$$
...
**Lời giải:**
- **Xác định nghiệm**: 
  - Giải phương trình $x^2 + 2\sqrt{2}x + 2 = 0$:
...
**Lời giải:**
- **Xác định nghiệm**: 
  - Giải phương trình $-3x^2 + 2x + 21 = 0$:

$$
\Delta = b^2 - 4ac = 2^2 - 4(-3)(21) = 4 + 252 = 256.
$$

$$
x_{1,2} = \frac{-2 \pm \sqrt{256}}{-6} = \frac{-2 \pm 16}{-6}.
$$

$$
x_1 = - \frac{7}{3} \quad \text{và} \quad x_2 = 3.
$$
...
**Lời giải:**
- **Xác định nghiệm**: 
  - Giải phương trình $-2x^2 + x - 2 = 0$:

$$
\Delta = b^2 - 4ac = 1^2 - 4(-2)(-2) = 1 - 16 = -15 < 0.
$$
...
$$
\Delta = 1^2 - 4(-0.1)(-1) = 1 - 0.4 = 0.6.
$$

$$
x_{1,2} = \frac{-1 \pm \sqrt{0.6}}{-0.2} \approx \frac{-1 \pm 0.8}{-0.2}.
$$

$$
x_1 \approx 1.0 \quad \text{và} \quad x_2 \approx 5.0.
$$
...
$$
\Delta = 3^2 - 4 \cdot 2 \cdot (m + 1) < 0.
$$

$$
9 - 8(m + 1) < 0 \Rightarrow 9 - 8m - 8 < 0.
$$

$$
-8m + 1 < 0 \Rightarrow m > \frac{1}{8}.
$$
...
1. **Ví dụ 1:** 
Các bất phương trình nào sau dây là bất phương trình bậc hai một ẩn? Nếu là bất phương trình bậc hai một ẩn, $x = 1$ và $x = 2$ có là nghiệm của bất phương trình đó hay không?
a) $x^2 + x - 3 \geq 0$;
b) $3x^3 + x^2 - 1 \leq 0.$
...
2. **Ví dụ 2:**
Các bất phương trình nào sau dây là bất phương trình bậc hai một ẩn? Nếu là bất phương trình bậc hai một ẩn, $x = -2$ có là nghiệm của bất phương trình đó hay không?
a) $x^2 + x - 6 \leq 0$;
b) $x + 2 > 0$;
c) $-6x^2 - 7x + 5 > 0.$
